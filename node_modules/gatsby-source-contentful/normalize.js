...
exports.buildEntryList = ({
  contentTypeItems,
  mergedSyncData
}) => contentTypeItems.map(contentType => mergedSyncData.entries.filter(entry => entry.sys.contentType.sys.id === contentType.sys.id));
    ...
    entryList[i].forEach(entryItem => {
      ...
      Object.keys(entryItemFields).forEach(entryItemFieldKey => {
        if (entryItemFields[entryItemFieldKey]) {
          ...
          } else if ((entryItemFieldValue === null || entryItemFieldValue === void 0 ? void 0 : (_entryItemFieldValue$ = entryItemFieldValue.sys) === null || _entryItemFieldValue$ === void 0 ? void 0 : _entryItemFieldValue$.type) && entryItemFieldValue.sys.id) {
